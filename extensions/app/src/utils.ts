...
export function getReadme(name: 'app' | 'app-appinit' | 'app-scene' | 'app-builtin' | 'app-bundle' | 'app-view' | 'app-admin' | 'app-control' | 'app-extend' | 'app-manager' | 'app-model' | 'app-sound' | 'effect' | 'music' | 'expansion' | 'native' | 'res-bundle' | 'res-native' | 'resources') {
    const Assets = join(__dirname, '../res/readme');
    return readFileSync(join(Assets, `.${name}.md`), 'utf-8');
}

export function getMeta(name: 'app-admin' | 'app-control' | 'app-extend' | 'app-manager' | 'app-model' | 'app-sound'): { userData: object } {
